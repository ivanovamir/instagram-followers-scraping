...
class Instagram():
	...
	def login(self):
		...
		try:
			...
			show_password = browser.find_element_by_xpath('/html/body/div[1]/section/main/div/div/div[1]/div[2]/form/div/div[2]/div/div/div/button')
			show_password.click()
	...
	def get_followers(self, users, amount):
		...
		for user in users:
			...
			followers_button = browser.find_element_by_xpath('/html/body/div[1]/section/main/div/header/section/ul/li[3]/a/div')
